...
export type MainType = AddWishListACType | RemoveWishListACType | ChangeWishListTitleACType | ChangeWishListFilterType
...
export type ChangeWishListFilterType = ReturnType<typeof changeWishListFilterAC>
